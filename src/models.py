...
def create_mlp_model(input_shape: Tuple[int, int, int], num_classes: int) -> Sequential:
    ...
    # Layer 2: Fully connected layer with 512 neurons, followed by a relu activation function
    model.add(Dense(512, activation='relu'))

    # Layer 3: Fully connected layer with 1024 neurons, followed by a relu activation function
    model.add(Dense(1024, activation='relu'))

    # Layer 4: Fully connected layer with 512 neurons, followed by a relu activation function
    model.add(Dense(512, activation='relu'))

    # Layer 5: Classification layer with num_classes output units, followed by a softmax activation function
